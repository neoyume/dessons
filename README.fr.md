...
- **Courbe de lecture** : déforme le temps de la tête de lecture sur la boucle — *linéaire* (régulier), *accéléré*, *ralenti*, *pulsé* (dense sur le temps, aéré au milieu) ou *swing*. Transforme le même motif de notes en grooves différents. Les petits traits sur le bord d'attaque de l'aperçu montrent où tombe chaque pas dans le temps. Repris aussi dans l'export.
